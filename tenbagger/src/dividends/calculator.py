...
class DividendCalculator:
    def __init__(self, port):
        ...
        self.payout = {
            month: self.res.query(f"month == {month}") for month in set(self.res.month)
        }

    def calulate_dividends(
        self, n, growth, monthly_payment, only_dividend_stocks=False
    ):
        """
...
if __name__ == "__main__":
    ...
    d.calulate_dividends(
        n=120, growth=0, monthly_payment=1200, only_dividend_stocks=True
    )
