from tenbagger.src.utils.utilities import read_yaml, Ticker, make_percentage, read_from_root
...
class Portfolio(PortfolioCrypto):
    def __init__(self, name_port):
        ...
        self.env = read_from_root('environment.yaml')
        self.tickers = {}
    ...
    def _select(self):
        if isinstance(self.name_port, dict):
            ...
            portfolio = read_from_root('portfolio.yaml')[self.name_port]
